...
min_crime_index = min(final$`Crime Index`)
...
final = final %>% 
  ...
  mutate(sixteen_plus_employed_percentage = str_replace(sixteen_plus_employed_percentage, "%", "")) %>% 
  mutate(edu_index_norm = average_education_index / max_education_index) 
